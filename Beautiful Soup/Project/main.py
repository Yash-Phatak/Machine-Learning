...
"""
    The above code is a Python script that scrapes Google News for COVID-related headlines and stores
    them in a Firebase database, and it also includes a scheduler function to trigger the scraper
    function every day at 12 AM.
"""
import pyrebase
import requests
